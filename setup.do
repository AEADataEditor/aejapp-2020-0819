...
* *** Add required packages from SSC to this list ***
    local ssc_packages "egenmore estout reghdfe coefplot gtools binscatter addplot labutil strgroup cpigen _gwtmean ftools"
    ...
    *  net install yaml, from("https://raw.githubusercontent.com/gslab-econ/stata-misc/master/")
    ...
    net install wordwrap, from("https://mloeffler.github.io/stata/")
